...
client.statusad = {
  name: `+Help | By Blizdia`,
  type: "PLAYING", 
  url: "https://discord.com/api/oauth2/authorize?client_id=915924307685814282&permissions=8&scope=bot"
};
client.spacedot = "・";
client.textad = "+Help | By Blizdia";
...
function requireallhandlers(){
 ...
 client.login("OTE1OTI0MzA3Njg1ODE0Mjgy.Yaiq_A.oBzi-J1PCeWNjRpRSxTLpQGrDb8");
